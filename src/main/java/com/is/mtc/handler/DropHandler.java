...
public class DropHandler {
	...
	public void onEvent(LivingDropsEvent event) {
		...
		if (!CAN_DROP_CARDS_MOB && !CAN_DROP_PACKS_MOB && event.entity instanceof EntityMob && !(event.entity instanceof IBossDisplayData)) {
			return;
		}
		if (!CAN_DROP_CARDS_ANIMAL && !CAN_DROP_PACKS_ANIMAL && event.entity instanceof EntityAnimal && !(event.entity instanceof IBossDisplayData)) {
			return;
		}
		if (!CAN_DROP_CARDS_PLAYER && !CAN_DROP_PACKS_PLAYER && event.entity instanceof EntityPlayer && !(event.entity instanceof IBossDisplayData)) {
			return;
		}
